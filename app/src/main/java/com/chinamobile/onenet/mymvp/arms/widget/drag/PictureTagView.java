package com.chinamobile.onenet.mymvp.arms.widget.drag;
...
public class PictureTagView extends RelativeLayout {
	...
	protected void initViews(){
		...
		//etPictureTagLabel = (EditText) findViewById(etPictureTagLabel);
...
/*	protected void initEvents(){
	...
	private void directionChange(){
		switch(direction){
		case Left:
			loTag.setBackgroundResource(R.drawable.ic_launcher);
			break;
		case Right:
			loTag.setBackgroundResource(R.drawable.mine);
			break;
		}
	}
