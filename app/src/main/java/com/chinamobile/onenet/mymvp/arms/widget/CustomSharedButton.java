 ...
 */
class CustomSharedButton extends View implements ValueAnimator.AnimatorUpdateListener {
    ...
    public CustomSharedButton(Context context) {
        super(context);
        init();
    }

    public CustomSharedButton(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }
