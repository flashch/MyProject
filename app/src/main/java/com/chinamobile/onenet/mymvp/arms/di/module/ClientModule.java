...
import com.chinamobile.onenet.mymvp.arms.http.RequestIntercept;
import com.chinamobile.onenet.mymvp.arms.utils.DataHelper;
...
public class ClientModule {
    ...
    File provideRxCacheDirectory(File cacheDir) {
        ...
        LogUtils.e("AAA","provideRxCacheDirectory创建文件夹cacheDirectory");
