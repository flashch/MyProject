...
@FragmentScope
public class RecommendLivingModel extends BaseModel<ServiceManager, CacheManager> implements RecommendLivingContract.Model {
    private Gson mGson;
    private Application mApplication;

    @Inject
    public RecommendLivingModel(ServiceManager serviceManager, CacheManager cacheManager, Gson gson, Application application) {
    ...
    @Override
    public Observable<List<HomeCarousel>> getModelHomeCarousel(@QueryMap Map<String, String> maps) {
        Observable<BaseJson<List<HomeCarousel>>> hotColumn = mServiceManager.getLivingService().getCarousel(maps);
        return hotColumn.
