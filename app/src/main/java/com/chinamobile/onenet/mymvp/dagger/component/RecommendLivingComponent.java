...
@FragmentScope
@Component(modules = RecommendLivingModule.class, dependencies = AppComponent.class)
public interface RecommendLivingComponent {
    void inject(RecommendLivingFragment fragment);
}