...
public interface RecommendLivingContract {
    ...
    interface Model extends IModel {
        ...
        Observable<List<HomeCarousel>> getModelHomeCarousel(@QueryMap Map<String, String> maps);
    }
}